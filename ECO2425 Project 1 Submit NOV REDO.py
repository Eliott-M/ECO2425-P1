...
axes[0, 0].hist(data['clsize_snv'].dropna(), bins=20, edgecolor='black')
axes[0, 0].set_title('a) Class Size')

axes[0, 1].hist(data['answers_math_pct'].dropna(), bins=20, edgecolor='black')
axes[0, 1].set_title('b) Math Test Scores (Percentage)')


axes[1, 0].hist(data['answers_ital_pct'].dropna(), bins=20, edgecolor='black')
axes[1, 0].set_title('c) Italian Test Scores (Percentage)')

axes[1, 1].hist(data['answers_math_std'].dropna(), bins=20, edgecolor='black')
axes[1, 1].set_title('d) Standardized Math Scores')


axes[2, 0].hist(data['answers_ital_std'].dropna(), bins=20, edgecolor='black')
axes[2, 0].set_title('e) Standardized Italian Scores')


axes[2, 1].hist(data['edu_gap'].dropna(), bins=20, edgecolor='black')
axes[2, 1].set_title('f) Parent Education Gap')


axes[3, 0].hist(data['enrol_sch_snv'].dropna(), bins=20, edgecolor='black')
axes[3, 0].set_title('g) School Enrollment')

axes[3, 1].hist(data['interaction_effect_eg_clsize'].dropna(), bins=20, edgecolor='black')
axes[3, 1].set_title('h) Parent Education Gap * Class Size')
...
cluster_model_math_2SLS_no_int_latex = cluster_model_math_2SLS_no_int.summary().as_latex()
...
document.add_heading('2SLS Math No Int', level=1)
document.add_paragraph(cluster_model_math_2SLS_no_int_latex)


document.add_heading('STAR', level=1)
from stargazer.stargazer import Stargazer

figure_star = Stargazer([cluster_model_math, cluster_model_math_2SLS_no_int, cluster_model_math_2SLS])
figure_star.title("Math Test Regression Output: Naive OLS, First Stage, 2SLS")
figure_star.custom_columns(["Naive OLS", "First Stage", "2SLS"], [1,1,1])
figure_star_latex = figure_star.render_latex()
print(figure_star_latex)
document.add_paragraph(figure_star_latex)

document.add_heading('STARFIRST', level=1)
from stargazer.stargazer import Stargazer

figure_starf = Stargazer([first_stage])
figure_starf.title("Math Test Regression Output: First")
figure_starf.custom_columns(["First"], [1])
figure_starf_latex = figure_starf.render_latex()
print(figure_starf_latex)
document.add_paragraph(figure_starf_latex)


document.add_heading('STARITAL', level=1)
from stargazer.stargazer import Stargazer

figure_stari = Stargazer([cluster_model_ital_2SLS])
figure_stari.title("Italian Test Regression Output: 2SLS")
figure_stari.custom_columns(["2SLS"], [1])
figure_stari_latex = figure_stari.render_latex()
print(figure_stari_latex)
document.add_paragraph(figure_stari_latex)
